...
| Music — title track + 5 gameplay tracks, scheduler, duck/unduck | ✅ Built | §10 | `audio.js` (SFX/buses/re-export), `music.js` (scheduler + all track data), `level.js`, `update.js`, `input.js`, `pause.js`, `playlists.js` |
